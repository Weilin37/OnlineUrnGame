    ...
    if (gameState.game_waiting === true) {
        return (
            <Grid container justify="center" alignItems="center" spacing={2}>
                ...
                <Grid item align="center" xs={12} >
                    <Typography variant="h5">If the game has not started in 5 minutes or the room code details are empty, please go back to the home screen and start a new room again.</Typography>
                </Grid>
                <Grid item align="center" xs={12} >
            ...
            <Grid container justify="center" alignItems="center" spacing={2}>
                ...
                <Grid item align="center" xs={8}>
                    <Paper>
                        <Grid item align="center" xs={12} >
                            <Typography className={classes.spacing} variant="subtitle1">
                                If you are a returning player, then please enter your room code and the Prolific ID you used and press the right button here
                            </Typography>
                        </Grid>
                        <Grid item align="center" xs={12} >
                            <TextField id="resume_alias" label="Enter Prolific ID" variant="outlined" />
